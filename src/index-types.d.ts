...
declare namespace Konva {
  ...
  export type AbsoluteRenderOrderGroup =
    import('./AbsoluteRenderOrderGroup').AbsoluteRenderOrderGroup;
  export type AbsoluteRenderOrderGroupConfig =
    import('./AbsoluteRenderOrderGroup').AbsoluteRenderOrderGroupConfig;
